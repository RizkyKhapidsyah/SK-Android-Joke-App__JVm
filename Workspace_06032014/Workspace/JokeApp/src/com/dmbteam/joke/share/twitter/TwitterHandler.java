...
/**
 * This class represents the Twitter Handles
 * 
 * @author |dmb TEAM|
 *
 */
public class TwitterHandler {
     ...
     * @param secretKey
     */
    public TwitterHandler(Activity context, String consumerKey,
                          String secretKey) {
    ...
    /**
     * Updates the status with a new one
     * @param status
     * @throws Exception
     */
    ...
    /**
     * Twitter dialog listener interface
     */
